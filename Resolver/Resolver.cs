...
namespace DNSResolver
{
    ...
    public class StubResolver : IResolver
    {
        ...
        public ResolverResult Resolve(Domain domain, ResourceRecordType rtype, EndPoint[] servers)
        {
            ...
            // (But only if we're looking specifically for CNAME or A records - other records
            ...
            if (rtype == ResourceRecordType.CANONICAL_NAME || rtype == ResourceRecordType.HOST_ADDRESS)
            {
